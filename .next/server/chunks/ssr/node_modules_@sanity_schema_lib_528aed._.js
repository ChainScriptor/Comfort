...
function parsePreview(preview) {
    ...
    return Array.isArray(select) ? __spreadProps$4(__spreadValues$6({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(preview, [
        "prepare",
        "component"
    ])), {
        select: parseSelection(select)
    }) : __spreadProps$4(__spreadValues$6({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(preview, [
        "prepare",
        "component"
    ])), {
        select
...
const CrossDatasetReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS$1.map((fieldDef)=>{
            ...
            })), lazyGetter(parsed, "to", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(subTypeDef.to).map((toType)=>__spreadProps$3(__spreadValues$3({}, toType), {
...
const OVERRIDABLE_FIELDS$8 = [
    ...
    extend (rawSubTypeDef, createMemberType) {
        const subTypeDef = __spreadValues$2({
            fields: []
        }, rawSubTypeDef), options = __spreadValues$2({}, subTypeDef.options || {}), parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(this.get(), OVERRIDABLE_FIELDS$8), subTypeDef, {
            type: this.get(),
...
var array = (typeDef, visitorContext)=>{
    ...
    const [primitiveTypes, objectTypes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$partition$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(of, (ofType)=>{
        var _a2;
...
function validateAnnotations(annotations, visitorContext, problems) {
    return annotations.map((annotation)=>{
        var _a, _b;
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isPlainObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(annotation)) return __spreadProps$9(__spreadValues$9({}, annotation), {
            _problems: [
