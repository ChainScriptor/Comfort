...
function _resolveKeyedPath(value, path) {
    ...
    if (typeof next == "number") {
        ...
        return [
            typeof (item == null ? void 0 : item._key) == "string" ? {
                _key: item._key
            } : next,
...
var __defProp$7 = Object.defineProperty, __defProps$6 = Object.defineProperties, __getOwnPropDescs$6 = Object.getOwnPropertyDescriptors, __getOwnPropSymbols$6 = Object.getOwnPropertySymbols, __hasOwnProp$6 = Object.prototype.hasOwnProperty, __propIsEnum$6 = Object.prototype.propertyIsEnumerable, __defNormalProp$7 = (obj, key, value)=>key in obj ? __defProp$7(obj, key, {
    ...
    for(var prop in b || (b = {}))__hasOwnProp$6.call(b, prop) && __defNormalProp$7(a, prop, b[prop]);
    if (__getOwnPropSymbols$6) for (var prop of __getOwnPropSymbols$6(b))__propIsEnum$6.call(b, prop) && __defNormalProp$7(a, prop, b[prop]);
    return a;
...
const PRESERVE_WHITESPACE_TAGS = [
    ...
    p: DEFAULT_BLOCK,
    blockquote: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "blockquote"
    })
}, HTML_SPAN_TAGS = {
    span: {
    ...
    h1: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "h1"
    }),
    h2: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "h2"
    }),
    h3: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "h3"
    }),
    h4: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "h4"
    }),
    h5: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "h5"
    }),
    h6: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: "h6"
    })
}, HTML_MISC_TAGS = {
    br: __spreadProps$6(__spreadValues$6({}, DEFAULT_BLOCK), {
        style: BLOCK_DEFAULT_STYLE
    })
}, HTML_DECORATOR_TAGS = {
    b: "strong",
...
function blockContentFeatures(blockContentType) {
    ...
    const ofType = (_b = (_a = blockType.fields.find(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBlockChildrenObjectField"])) == null ? void 0 : _a.type) == null ? void 0 : _b.of;
...
var preprocessHTML = (html, doc)=>{
    ...
    for(let i = bodyTextNodes.snapshotLength - 1; i >= 0; i--){
        ...
        } else (_b = node.parentNode) == null || _b.removeChild(node);
    }
    ...
    function processNode(node) {
        var _a, _b;
        if (node.nodeType === _XPathResult.BOOLEAN_TYPE && !PRESERVE_WHITESPACE_TAGS.includes(((_a = node.parentElement) == null ? void 0 : _a.tagName.toLowerCase()) || "")) node.textContent = ((_b = node.textContent) == null ? void 0 : _b.replace(/\s\s+/g, " ").replace(/[\r\n]+/g, " ")) || "";
...
function isWhitespaceBlock(elm) {
    ...
    return [
        "p",
        "br"
    ].includes(tagName(elm) || "") && !((_a = elm.textContent) != null && _a.trim());
}
...
function createGDocsRules(_blockContentType, options) {
    return [
        ...
        },
        {
            deserialize (el, next) {
                var _a;
                if (tagName(el) === "li" && isGoogleDocs(el)) return __spreadProps$4(__spreadValues$4({}, DEFAULT_BLOCK), {
        ...
        },
        {
            deserialize (el) {
                var _a;
                if (tagName(el) === "br" && isGoogleDocs(el) && isElement(el) && el.classList.contains("apple-interchange-newline")) return __spreadProps$4(__spreadValues$4({}, DEFAULT_SPAN), {
                    text: ""
                });
                if (tagName(el) === "br" && isGoogleDocs(el) && isElement(el) && ((_a = el == null ? void 0 : el.parentNode) == null ? void 0 : _a.textContent) === "") return __spreadProps$4(__spreadValues$4({}, DEFAULT_SPAN), {
                    text: ""
                });
                if (tagName(el) === "br" && isGoogleDocs(el) && isElement(el) && isRootNode(el)) return __spreadProps$4(__spreadValues$4({}, DEFAULT_SPAN), {
                    text: ""
                });
            }
        }
    ...
    return [
        // Text nodes
        {
            deserialize (el) {
                ...
                if (el.nodeName === "#text" && isValidText) return __spreadProps$3(__spreadValues$3({}, DEFAULT_SPAN), {
                    marks: [],
        ...
        // Block elements
        {
            deserialize (el, next) {
                ...
                if (block) return el.parentNode && tagName(el.parentNode) === "li" ? next(el.childNodes) : (options.enabledBlockStyles.includes(block.style) || (block = DEFAULT_BLOCK), __spreadProps$3(__spreadValues$3({}, block), {
        ...
        {
            deserialize (el) {
                if (tagName(el) === "br") return __spreadProps$3(__spreadValues$3({}, DEFAULT_SPAN), {
                    text: `
`
                });
            }
...
function createWordRules() {
    return [
        {
            deserialize (el, next) {
                if (tagName(el) === "p" && isWordListElement(el)) return __spreadProps$1(__spreadValues$1({}, DEFAULT_BLOCK), {
...
class HtmlDeserializer {
   ...
   */ constructor(blockContentType, options = {}){
        __publicField(this, "blockContentType"), __publicField(this, "rules"), __publicField(this, "parseHtml"), __publicField(this, "_markDefs", []), __publicField(this, "deserialize", (html)=>{
            this._markDefs = [];
            const { parseHtml: parseHtml2 } = this, fragment = parseHtml2(html), children = Array.from(fragment.childNodes), blocks2 = trimWhitespace(flattenNestedBlocks(ensureRootIsBlocks(this.deserializeElements(children))));
            ...
            for(let i = 0; i < this.rules.length; i++){
                ...
                if (ret !== void 0) {
                    ...
                    if (ret && !Array.isArray(ret) && isMinimalBlock(ret) && "listItem" in ret) {
                        ...
                        for(; parent && tagName(parent) === "li";)parent = (_b = parent.parentNode) == null ? void 0 : _b.parentNode, ret.level = ret.level ? ret.level + 1 : 1;
                    }
...
function normalizeBlock(node, options = {}) {
    if (node._type !== (options.blockTypeName || "block")) return "_key" in node ? node : __spreadProps(__spreadValues({}, node), {
        _key: randomKey(12)
    });
...
var __defProp$h = Object.defineProperty, __defNormalProp$h = (obj, key, value)=>key in obj ? __defProp$h(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$h = (obj, key, value)=>__defNormalProp$h(obj, typeof key != "symbol" ? key + "" : key, value);
...
var __defProp$g = Object.defineProperty, __defNormalProp$g = (obj, key, value)=>key in obj ? __defProp$g(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$g = (obj, key, value)=>__defNormalProp$g(obj, typeof key != "symbol" ? key + "" : key, value);
...
var __defProp$f = Object.defineProperty, __defNormalProp$f = (obj, key, value)=>key in obj ? __defProp$f(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$f = (obj, key, value)=>__defNormalProp$f(obj, typeof key != "symbol" ? key + "" : key, value);
class Parser {
    constructor(path){
...
var __defProp$e = Object.defineProperty, __defNormalProp$e = (obj, key, value)=>key in obj ? __defProp$e(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$e = (obj, key, value)=>__defNormalProp$e(obj, key + "", value);
class Expression {
    constructor(expr){
        if (__publicField$e(this, "expr"), !expr) throw new Error("Attempted to create Expression from null-value");
...
var __defProp$d = Object.defineProperty, __defNormalProp$d = (obj, key, value)=>key in obj ? __defProp$d(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$d = (obj, key, value)=>__defNormalProp$d(obj, typeof key != "symbol" ? key + "" : key, value);
class Descender {
...
var __defProp$c = Object.defineProperty, __defNormalProp$c = (obj, key, value)=>key in obj ? __defProp$c(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$c = (obj, key, value)=>__defNormalProp$c(obj, typeof key != "symbol" ? key + "" : key, value);
class Matcher {
...
var __defProp$b = Object.defineProperty, __defNormalProp$b = (obj, key, value)=>key in obj ? __defProp$b(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$b = (obj, key, value)=>__defNormalProp$b(obj, typeof key != "symbol" ? key + "" : key, value);
class PlainProbe {
    constructor(value, path){
...
var __defProp$a = Object.defineProperty, __defNormalProp$a = (obj, key, value)=>key in obj ? __defProp$a(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$a = (obj, key, value)=>__defNormalProp$a(obj, typeof key != "symbol" ? key + "" : key, value);
...
class DiffMatchPatch {
    constructor(id, path, dmpPatchSrc){
        __publicField$a(this, "path"), __publicField$a(this, "dmpPatch"), __publicField$a(this, "id"), this.id = id, this.path = path, this.dmpPatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$diff$2d$match$2d$patch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePatch"])(dmpPatchSrc);
    }
...
var __defProp$9 = Object.defineProperty, __defNormalProp$9 = (obj, key, value)=>key in obj ? __defProp$9(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$9 = (obj, key, value)=>__defNormalProp$9(obj, typeof key != "symbol" ? key + "" : key, value);
...
var __defProp$8 = Object.defineProperty, __defNormalProp$8 = (obj, key, value)=>key in obj ? __defProp$8(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$8 = (obj, key, value)=>__defNormalProp$8(obj, typeof key != "symbol" ? key + "" : key, value);
class InsertPatch {
...
var __defProp$7 = Object.defineProperty, __defNormalProp$7 = (obj, key, value)=>key in obj ? __defProp$7(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$7 = (obj, key, value)=>__defNormalProp$7(obj, typeof key != "symbol" ? key + "" : key, value);
...
var __defProp$6 = Object.defineProperty, __defNormalProp$6 = (obj, key, value)=>key in obj ? __defProp$6(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __publicField$6 = (obj, key, value)=>__defNormalProp$6(obj, typeof key != "symbol" ? key + "" : key, value);
class SetPatch {
    constructor(id, path, value){
...
var __defProp$5 = Object.defineProperty, __defNormalProp$5 = (obj, key, value)=>key in obj ? __defProp$5(obj, key, {
        ...
        writable: !0,
        value
    }) : obj[key] = value, __publicField$5 = (obj, key, value)=>__defNormalProp$5(obj, typeof key != "symbol" ? key + "" : key, value);
class UnsetPatch {
    constructor(id, path){
...
var __defProp$4 = Object.defineProperty, __defNormalProp$4 = (obj, key, value)=>key in obj ? __defProp$4(obj, key, {
        ...
        writable: !0,
        value
    }) : obj[key] = value, __publicField$4 = (obj, key, value)=>__defNormalProp$4(obj, key + "", value);
class Patcher {
    constructor(patch){
...
var __defProp$3 = Object.defineProperty, __defNormalProp$3 = (obj, key, value)=>key in obj ? __defProp$3(obj, key, {
        ...
        writable: !0,
        value
    }) : obj[key] = value, __publicField$3 = (obj, key, value)=>__defNormalProp$3(obj, typeof key != "symbol" ? key + "" : key, value);
class Mutation {
    constructor(options){
...
var __defProp$4 = Object.defineProperty, __getOwnPropSymbols = Object.getOwnPropertySymbols, __hasOwnProp = Object.prototype.hasOwnProperty, __propIsEnum = Object.prototype.propertyIsEnumerable, __defNormalProp$4 = (obj, key, value)=>key in obj ? __defProp$4(obj, key, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value
    }) : obj[key] = value, __spreadValues = (a, b)=>{
    for(var prop in b || (b = {}))__hasOwnProp.call(b, prop) && __defNormalProp$4(a, prop, b[prop]);
    if (__getOwnPropSymbols) for (var prop of __getOwnPropSymbols(b))__propIsEnum.call(b, prop) && __defNormalProp$4(a, prop, b[prop]);
    return a;
};
...
function removedString(input, toValue, options) {
    return {
        ...
        annotation: input.annotation,
        get segments () {
            const segments = input.sliceAnnotation(0, input.value.length).map((segment)=>__spreadValues({
                    type: "stringSegment",
                    action: "removed"
                }, segment));
            return replaceProperty(this, "segments", segments);
...
const visionTool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["definePlugin"])((options)=>{
    const _a = options || {}, { name, title, icon } = _a, config = __objRest(_a, [
        "name",
        "title",
        "icon"
    ]);
